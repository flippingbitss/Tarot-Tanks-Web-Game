...
export class InstructionsScene extends Stage {
  ...
  Main() {
    ...
    this.objective = new Label("Objective: Destroy the enemy tanks", 25, FONT_FAMILY, "green", WIDTH/2, HEIGHT / 4 ,true);

	this.cards1 = new Label("The Devil    - Enemies repair themselves", 20, FONT_FAMILY, "yellow", WIDTH/5, HEIGHT / 2.5 -50 ,false);
    this.cards2 = new Label("The Chariot  - Faster bullets", 20, FONT_FAMILY, "yellow", WIDTH/5, HEIGHT / 2.5 ,false);
    this.cards3 = new Label("The Sun      - Revive dead enemies", 20, FONT_FAMILY, "yellow", WIDTH/5, HEIGHT / 2.5 + 50,false);
	this.cards4 = new Label("The Magician - Increase powerup spawn frequency", 20, FONT_FAMILY, "yellow", WIDTH/5, HEIGHT/ 2.5 + 100 ,false);
